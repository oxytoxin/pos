    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="px-4 py-8 bg-white shadow sm:rounded-lg sm:px-10">
            <form wire:submit.prevent="authenticate">
                <div>
                    <label for="credential" class="block text-sm font-medium leading-5 text-gray-700">
                        Email/ Username/ Phone
                    </label>

                    <div class="mt-1 rounded-md shadow-sm">
                        <input wire:model.lazy="credential" id="credential" name="credential" type="credential" required autocomplete="off" autofocus class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5 @error('credential') border-red-300 text-red-900 placeholder-red-300 focus:border-red-300 focus:shadow-outline-red @enderror" />
                    </div>
