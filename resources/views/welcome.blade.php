                ...
                <div class="space-y-6">
                    ...
                    <ul class="list-reset">
                        <li class="inline px-4">
                            <a href="/pos" class="font-medium text-indigo-600 transition duration-150 ease-in-out hover:text-indigo-500 focus:outline-none focus:underline">POS</a>
                        </li>
                        <li class="inline px-4">
                            <a href="/dashboard" class="font-medium text-indigo-600 transition duration-150 ease-in-out hover:text-indigo-500 focus:outline-none focus:underline">DASHBOARD</a>
                        </li>
                    </ul>
                </div>
            </div>
